    ...
    foreach($donnees as $donnee){
        $sortie .= '
            <tr>
                ...
                <td><a href="photo/'.$donnee->matricule.'"><i class="text-primary fa fa-camera capture" style="cursor:pointer;" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Capturer l\'étudiant(e)" ></i></a></td>
            </tr>
