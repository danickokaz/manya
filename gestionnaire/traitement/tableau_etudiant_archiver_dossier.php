...
$req = database()->prepare("SELECT e.id,e.matricule,CONCAT(e.nom,' ',e.postnom,' ', e.prenom) nomcomplet,g.libelle_genre,ec.libelle_etat_civil,e.telephone,ti.libelle_type_inscription FROM 
    ...
    foreach($donnees as $donnee){
        $sortie .= '
            <tr>
                ...
                <td><i class="text-primary fa fa-file upload" id="'.$donnee->id.'" style="cursor:pointer;" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Ajouter les dossiers de l\'étudiant(e)" ></i></td>
            </tr>
