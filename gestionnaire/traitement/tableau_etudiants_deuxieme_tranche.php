...
$req->execute([3,$classe,$salle,$annee_academique]);
...
if($req->rowCount()>0){
    ...
    $sortie .= '
        ...
        <a href="esdeuxiemetranche/'.$classe.'/'.$salle.'/'.$annee_academique.'" class="btn btn-primary mt-2 mb-2"><i class="fa fa-print"></i>  Imprimer le tableau</a>
